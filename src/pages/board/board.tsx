...
export function BoardPage() {
  ...
  const { handleDragStart: handleNoteDragStart, handleTouchStart: handleNoteTouchStart } = useNoteDrag({
    boardRef,
    zoom,
    panOffset,
    notes,
        ...
        {notes.map((note, index) => {
          ...
          <div
            ...
            style={{
              ...
              transform: `rotate(${note.rotation}deg)${isHighlighted ? ' scale(1.05)' : ''}`,
            ...
            onClick={() => isHighlighted && clearHighlight(note.id)}
          >
            {/* Tape effect */}
            <div 
